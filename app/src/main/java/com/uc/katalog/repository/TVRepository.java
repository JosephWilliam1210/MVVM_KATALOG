...
import com.uc.katalog.model.Caster;
import com.uc.katalog.model.CasterResponse;
...
public class TVRepository {
    ...
    public MutableLiveData<List<Caster>>getCasts(int id){
        MutableLiveData<List<Caster>> listCasts = new MutableLiveData<>();

        service.getCasts(Constants.Type.TVSHOWS, id).enqueue(new Callback<CasterResponse>() {
            @Override
            public void onResponse(Call<CasterResponse> call, Response<CasterResponse> response) {
            ...
            @Override
            public void onFailure(Call<CasterResponse> call, Throwable t) {
